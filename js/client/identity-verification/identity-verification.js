document.addEventListener('DOMContentLoaded', async function () {
    ...
    window.checkExistingApplication = function () {
        return new Promise((resolve, reject) => {
            fetch('php/client/identity-verification/get-uploaded-document.php')
        ...
        if (previewContainer) {
            ...
            if (documentPath) {
                ...
                if (['jpg', 'jpeg', 'png'].includes(fileExt)) {
                    ...
                    img.src = `php/client/identity-verification/view-document.php?path=${encodeURIComponent(documentPath)}`;
                    ...
                    pdfLink.href = `php/client/identity-verification/view-document.php?path=${encodeURIComponent(documentPath)}`;
