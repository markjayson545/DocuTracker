document.addEventListener("DOMContentLoaded", function () {
    ...
    function showDetailsModal(reqId) {
        ...
        fetch('../backend/client/user-request-history/fetch-document-request-details.php',
            {
                method: 'POST',
                body: data
            }
    ...
    function downloadDocument(docPath) {
        ...
        fetch('../backend/services/client-only-get-document.php',
            {
                method: 'POST',
                body: data
    ...
    async function fetchDocumentPreview(docPath) {
        ...
        return await fetch('../backend/services/client-only-get-document.php', {
            method: 'POST',
            body: data
        })
            .then(response => {
    ...
    function fetchRequestHistory() {
        fetch('../backend/client/user-request-history/fetch-user-request-history.php')
            .then(response => response.json())
            .then(data => {
                console.log(data);
                if (data.success) {
