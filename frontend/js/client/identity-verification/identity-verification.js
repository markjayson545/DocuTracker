document.addEventListener('DOMContentLoaded', async function () {
    ...
    window.checkExistingApplication = function () {
        return new Promise((resolve, reject) => {
            fetch('../backend/client/identity-verification/get-uploaded-document.php')
                            ...
                            if (data.documents && data.documents.length > 0) {
                                ...
                                data.documents.forEach(doc => {
                                    ...
                                    if (['jpg', 'jpeg', 'png'].includes(fileExt)) {
                                        previewHtml = `<img src="../backend/client/identity-verification/view-document.php?path=${encodeURIComponent(doc.document_path)}" alt="${doc.document_type}">`;
                                    } else if (fileExt === 'pdf') {
                                    ...
                                    docItem.innerHTML = `
                                        ...
                                        <div class="document-info">
                                            ...
                                            <a href="../backend/client/identity-verification/view-document.php?path=${encodeURIComponent(doc.document_path)}" target="_blank" class="view-document-btn">
        ...
        if (previewContainer) {
            ...
            if (documentPath) {
                ...
                if (['jpg', 'jpeg', 'png'].includes(fileExt)) {
                    ...
                    img.src = `../backend/client/identity-verification/view-document.php?path=${encodeURIComponent(documentPath)}`;
                    ...
                    pdfLink.href = `../backend/client/identity-verification/view-document.php?path=${encodeURIComponent(documentPath)}`;
