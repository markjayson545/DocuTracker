...
function submitCredentialChange(formData, successMessage) {
    ...
    fetch('../backend/admin/admin-settings/handle-admin-credentials.php', {
        method: 'POST',
        body: formData
    })
...
function fetchAdminUsername() {
    return fetch('../backend/admin/admin-settings/get-admin-credentials.php?action=getUsername')
        .then(response => response.json())
        .then(data => {
            if (data.success) {
...
function fetchAdminEmail() {
    return fetch('../backend/admin/admin-settings/get-admin-credentials.php?action=getEmail')
        .then(response => response.json())
        .then(data => {
            if (data.success) {
                return data.email;
...
function fetchAndDisplayAdminInfo() {
    fetch('../backend/admin/admin-settings/get-admin-credentials.php?action=getUserInfo')
        .then(response => response.json())
        .then(data => {
            if (data.success) {
