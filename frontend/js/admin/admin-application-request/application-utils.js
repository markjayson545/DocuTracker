...
async function fetchApplicationDetails(applicationID) {
    try {
        ...
        const response = await fetch('../backend/admin/admin-manage-applications/fetch-admin-application-details.php', {
            body: body,
            method: 'POST'
        });
...
async function fetchApplicationRequests(page = 1, searchTerm = '') {
    try {
        let url = '../backend/admin/admin-manage-applications/fetch-admin-application-request.php';
...
async function handleAdminAction(action, applicationId, adminNotes = '') {
    try {
        ...
        const response = await fetch('../backend/admin/admin-manage-applications/handle-admin-action.php', {
            method: 'POST',
            body: formData
        });
