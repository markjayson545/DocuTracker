document.addEventListener("DOMContentLoaded", function () {
    ...
    const performSearch = debounce(async (searchTerm) => {
        ...
        try {
            ...
            const response = await fetch(`../backend/admin/search-query.php?action=searchAll&value=${encodeURIComponent(searchTerm)}`);
    ...
    window.performSpecificSearch = function (type, searchTerm) {
        ...
        fetch(`../backend/admin/search-query.php?action=search${type}&value=${encodeURIComponent(searchTerm)}`)
