...
`;
    ...
    window.fetchUserDetails = function (userId) {
        ...
        fetch(`../backend/admin/admin-manage-users/fetch-admin-user-details.php`, {
            method: "POST",
            body: formData,
        })
    ...
    async function getUserProfileImage(path) {
        ...
        await fetch('../backend/services/get-document.php', {
            method: 'POST',
            body: formData
    ...
    window.fetchUserDocuments = function (userId) {
        const formData = new FormData();
        formData.append("user_id", userId);
        fetch(`../backend/admin/admin-manage-users/fetch-admin-user-application-doc.php`, {
            method: "POST",
            body: formData,
        })
            .then(response => response.json())
    ...
    window.fetchUsersData = function (page = 1, searchTerm = "") {
        ...
        let url = `../backend/admin/admin-manage-users/fetch-admin-user-manage.php?page=${page}`;
        if (searchTerm) {
    ...
    function loadProfileImages() {
        ...
        profileImgs.forEach(img => {
            ...
            if (profilePath && profilePath !== '') {
                ...
                fetch('../backend/services/get-document.php', {
                    method: 'POST',
                    body: formData
                })
                    .then(response => {
    ...
    function openModal(userId) {
        ...
        document.getElementById("personal-info-form").addEventListener("submit", function (event) {
            ...
            formData.append("user_id", userId);
            fetch(`../backend/admin/admin-manage-users/update-user.php`, {
                method: "POST",
                body: formData,
            })
                .then(response => response.json())
        ...
        function handleAction(action) {
            ...
            fetch(`../backend/admin/admin-manage-users/user-actions.php`, {
                method: "POST",
                body: formData,
            })
                .then(response => response.json())
