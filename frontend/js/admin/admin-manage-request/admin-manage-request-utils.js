...
const AdminRequestUtils = {
    ...
    getRequestDetails: async function(reqId, onUserIdRetrieved) {
        let userId = null;
        await fetch('../backend/services/get-requests.php?action=getRequest&request_id=' + reqId)
        ...
        await fetch('../backend/services/get-user-info.php', {
            method: 'POST',
            body: formData
        })
            .then(response => response.json())
    ...
    getVerificationDocuments: function(userId) {
        const formData = new FormData();
        formData.append("user_id", userId);
        fetch('../backend/services/get-verification-documents.php', {
            method: 'POST',
            body: formData
        }).then(response => response.json())
            .then(data => {
    ...
    fetchRequests: async function(page = 1, searchTerm = '') {
        try {
            let url = '../backend/admin/admin-manage-requests/fetch-user-document-request.php';
